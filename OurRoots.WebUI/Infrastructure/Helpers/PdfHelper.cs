...
namespace OurRoots.WebUI.Infrastructure.Helpers
{
    ...
    public class PdfHelper
    {
        ...
        //    try {
        //        string docName = String.Format(@"OurRoots_Sales_{0}.pdf", UgandaDateTime.DateNow().Date.ToString("ddMMMyyyy"));
        //        docName = FileService.RemoveIllegalCharacters(docName, true);

        //        string destinationFolder = @"~/App_Data";

        //        //string logo = HttpContext.Current.Server.MapPath("~/Content/Imgs/OurRoots_logo.png");
        ...
        //        doc.Add(ParsePageHeading("OurRoots Periodical Sales Report"));
        ...
        //        table.AddCell(LabelCell("Sales Revenue (USD)"));
        //        table.AddCell(LabelCell("Profit (USD)"));
