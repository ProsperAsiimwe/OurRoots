...
namespace OurRoots.WebUI.Controllers
{
    public class BaseController : Controller
    {
        ...
        protected string QuotationNotificationMsg(QuoteRequest quote)
        {
            var controller = new ControllerHelper(this.ControllerContext);
            return controller.RenderRazorViewToString("Mail/_NotifyAdminQuotation", quote);
        }
        ...
        protected string OrdersNotificationMsg(Order order)
        {
            var controller = new ControllerHelper(this.ControllerContext);
            return controller.RenderRazorViewToString("Mail/_NotifyAdminOrders", order);
        }
